...
export function SameLocationSheet({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none fixed inset-0 z-[995] isolate flex items-end justify-center px-2 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pt-16 transition-all duration-400 ease-out will-change-[transform,opacity] sm:p-3",
