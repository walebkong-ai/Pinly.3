  ...
  try {
    ...
    const post = await prisma.post.create({
      data: {
        ...
        mediaUrl,
        thumbnailUrl,
        mediaAspectRatio: parsed.data.mediaAspectRatio ?? null,
        mediaWidth: parsed.data.mediaWidth ?? null,
        mediaHeight: parsed.data.mediaHeight ?? null,
        cropZoom: parsed.data.cropZoom ?? null,
        cropOffsetX: parsed.data.cropOffsetX ?? null,
        cropOffsetY: parsed.data.cropOffsetY ?? null,
